...
# ╔═╡ f3878520-1e2b-11eb-1bdc-d52a03a801e2
using Images, TestImages, Colors, FFTW, Plots

# ╔═╡ 439dff92-1e2c-11eb-20ab-7168e8e881d7
img = load("moonLanding.png")

# ╔═╡ a336f774-1e2c-11eb-3edf-5faf73586b7e
imgGray = Gray.(img)

# ╔═╡ f46007ca-1e2d-11eb-0bd2-29ec6debc119
mat = convert(Array{Float64}, imgGray)

# ╔═╡ 52d80062-1e30-11eb-2528-b1c65b733d96
fftMat = fft(mat)

# ╔═╡ 3a64e0b6-1e55-11eb-2c04-ddb8a576109f
fftMatBefore = Gray.(abs.(fftMat))

# ╔═╡ 9fd94658-1e4b-11eb-19a4-fdf1fdaa0822
v,h = size(fftMat)

# ╔═╡ 3b239586-1e57-11eb-361c-0f0f79ff73b1
sizeBoxVertical = 50

# ╔═╡ b1d22cd6-1e4f-11eb-37d9-7ddd9853ff95
sizeBoxHorizontal = 50;

# ╔═╡ c60273d6-1e4b-11eb-198c-d96a183f4f3e
fftMat[sizeBoxHorizontal:v-sizeBoxHorizontal,:] .= 0.0;

# ╔═╡ d4eb4e94-1e4c-11eb-1a4f-b76d9b2712bc
fftMat[h-sizeBoxHorizontal:v-sizeBoxHorizontal,:] .= 0.0;

# ╔═╡ 1bf88798-1e4d-11eb-00e7-47be3bedad9e
fftMat[:, sizeBoxVertical: h-sizeBoxVertical] .= 0.0;

# ╔═╡ 2b0b88a2-1e4d-11eb-2ba5-919051ba2198
fftMat[:, h-sizeBoxVertical:v-sizeBoxVertical] .= 0.0;

# ╔═╡ 07086044-1e37-11eb-1ecb-43b6ba855289
Gray.(abs.(fftMat))

# ╔═╡ a2c53466-1e33-11eb-2eb3-7513027c1517
inverseFFT = ifft(fftMat)

# ╔═╡ d31df92c-1e33-11eb-1b65-4fe3b612522f
imgAfterFFT = Gray.(abs.(inverseFFT))

# ╔═╡ def9f23e-1e34-11eb-22bf-1b3421e56274
[img imgAfterFFT]
